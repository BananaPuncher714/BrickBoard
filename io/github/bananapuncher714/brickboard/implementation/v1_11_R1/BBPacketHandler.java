package io.github.bananapuncher714.brickboard.implementation.v1_11_R1;
...
import io.github.bananapuncher714.brickboard.api.events.PlayerRecieveMessageEvent;
...
public class BBPacketHandler implements PacketHandler {
	...
	private static final Field FIELD_CHAT_POSITION;
	...
	static {
		...
		try {
			...
			field2 = PacketPlayOutChat.class.getDeclaredField( "b" );
		...
		FIELD_CHAT_POSITION = field2;
		FIELD_CHAT_POSITION.setAccessible( true );
	...
	public void sendMessage( Player player, ChatMessage component ) {
		...
		PacketPlayOutChat packet = new PacketPlayOutChat( icbc, ( byte ) 0 );
		( ( CraftPlayer ) player ).getHandle().playerConnection.sendPacket( packet );
	}
